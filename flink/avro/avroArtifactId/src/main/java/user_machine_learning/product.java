...
public class product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"product\",\"namespace\":\"user_machine_learning\",\"fields\":[{\"name\":\"product_id\",\"type\":\"string\",\"default\":\"null\"},{\"name\":\"company_name\",\"type\":\"string\",\"default\":\"null\"},{\"name\":\"product_info\",\"type\":\"string\",\"default\":\"null\"},{\"name\":\"direction\",\"type\":\"string\",\"default\":\"null\"}]}");
  ...
  public static user_machine_learning.product.Builder newBuilder() {
    return new user_machine_learning.product.Builder();
  }
  
  /** Creates a new product RecordBuilder by copying an existing Builder */
  public static user_machine_learning.product.Builder newBuilder(user_machine_learning.product.Builder other) {
    return new user_machine_learning.product.Builder(other);
  }
  
  /** Creates a new product RecordBuilder by copying an existing product instance */
  public static user_machine_learning.product.Builder newBuilder(user_machine_learning.product other) {
    return new user_machine_learning.product.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<product>
    ...
    private Builder() {
      super(user_machine_learning.product.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(user_machine_learning.product.Builder other) {
      super(other);
    ...
    private Builder(user_machine_learning.product other) {
            super(user_machine_learning.product.SCHEMA$);
      if (isValidValue(fields()[0], other.product_id)) {
        this.product_id = data().deepCopy(fields()[0].schema(), other.product_id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'product_id' field */
    public user_machine_learning.product.Builder setProductId(java.lang.CharSequence value) {
    ...
    public user_machine_learning.product.Builder clearProductId() {
      product_id = null;
    ...
    /** Sets the value of the 'company_name' field */
    public user_machine_learning.product.Builder setCompanyName(java.lang.CharSequence value) {
    ...
    public user_machine_learning.product.Builder clearCompanyName() {
      company_name = null;
    ...
    /** Sets the value of the 'product_info' field */
    public user_machine_learning.product.Builder setProductInfo(java.lang.CharSequence value) {
    ...
    public user_machine_learning.product.Builder clearProductInfo() {
      product_info = null;
    ...
    /** Sets the value of the 'direction' field */
    public user_machine_learning.product.Builder setDirection(java.lang.CharSequence value) {
    ...
    public user_machine_learning.product.Builder clearDirection() {
      direction = null;
