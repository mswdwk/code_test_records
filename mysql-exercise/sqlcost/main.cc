...
extern void init_optimizer_cost_module(bool enable_plugins) ;
extern Query_logger query_logger;
extern void my_error_handler_hook(uint err, const char *str, myf my) ;
...
int main(int argc, char *argv[])
{
  ...
  error_handler_hook=my_error_handler_hook;
  ...
  Mock_error_handler handler(thd, ER_PARSE_ERROR);
